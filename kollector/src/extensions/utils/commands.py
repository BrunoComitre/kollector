...
from kollector.src.extensions.utils.auth import create_user # from pydaria.ext.auth import create_user
from kollector.src.domain.models.models import Product # from pydaria.models import Product
# NO IMPORT DA LINHA 8 VER COMO ESTÃO OS ARQUIVOS DA API FASTAPI E SEPARAR MODELS COM NOME DE ARQUIVO E IMPORT DE ACORDO COM ARQUIVO MODEL SEPARADO
